...
import qf.apis.com.LoginAPI;
import qf.connection.com.RestClient;
...
public class api_Login {
	...
	//	mapper.writeValue(new File("D:\\Workspace\\Automation\\DAAR\\frame.testing\\daar\\utility\\com\\login.json"), login);
	//	getBareertoken();
